...
# I worked on this challenge [by myself, with: Yuzu Saijo].
...
# 5. Reflection 
# I'm relying on tests to be correct. If tests aren't written well, debugging could be a nightmare.
# else return false is redundant, but helps for readability
# First time pairing with Yuzu. She's confident with refactoring & triangles! (Instead of line-by-line, just took the understanding of what we were doing and started again from scratch. --> good approach for "fresh eyes")
# Ruby is shifting from painful to fun.